...
export const Tests = () => {
  return (
    <div className="w-full pb-20 bg-[#534559] text-white">
      <h1 className="text-[45px] mb-20 bg-gradient-to-t from-[#D1AA80] via-[#D9B895] to-[#EFDFCF] inline-block text-transparent bg-clip-text font-extrabold text-center w-full leading-[3.2rem] pt-5">
        TESTES DE INTELIGÊNCIA EMOCIONAL
      </h1>
      <div className="bg-gradient-to-tl from-[#534559] to-[#9A8A9D] mx-[200px] my-[20px] relative h-[20%] rounded-md p-1">
        <Link href="/register">
          <div className="bg-gradient-to-tl from-[#534559] to-[#816F86] relative h-[20%] rounded-md py-4 px-3 flex justify-center items-center">
            <BiBrain size={200} className="mr-4" />
            <div className="relative h-full w-full">
              <h1 className="text-4xl font-extrabold w-full bg-gradient-to-t from-[#D1AA80] via-[#D9B895] to-[#EFDFCF] inline-block text-transparent bg-clip-text">
                Four Elements
              </h1>
              <p className="text-xl w-full line-clamp-5">
      ...
      <div className="bg-gradient-to-tl from-[#534559] to-[#9A8A9D] mx-[200px] my-[20px] relative h-[20%] rounded-md p-1">
        <Link href="/register">
          <div className="bg-gradient-to-tl from-[#534559] to-[#816F86] relative h-[20%] rounded-md py-4 px-3 flex justify-center items-center">
            <GiUnbalanced size={200} className="mr-4" />
            <div className="relative h-full w-full">
              <h1 className="text-4xl font-extrabold w-full bg-gradient-to-tr from-[#D1AA80] via-[#D9B895] to-[#EFDFCF] inline-block text-transparent bg-clip-text">
                Equílibrio de Vida
              </h1>
              <p className="text-xl w-full line-clamp-5">
      ...
      <div className="bg-gradient-to-tl from-[#534559] to-[#9A8A9D] mx-[200px] my-[20px] relative h-[20%] rounded-md p-1">
        <Link href="/register">
          <div className="bg-gradient-to-tl from-[#534559] to-[#816F86] relative h-[20%] rounded-md py-4 px-3 flex justify-center items-center">
            <GiLovers size={200} className="mr-4" />
            <div className="relative h-full w-full">
              <h1 className="text-4xl font-extrabold w-full bg-gradient-to-tr from-[#D1AA80] via-[#D9B895] to-[#EFDFCF] inline-block text-transparent bg-clip-text">
                Como sentir o Afeto e Amor
              </h1>
              <p className="text-xl w-full line-clamp-4">
      ...
      <div className="bg-gradient-to-tl from-[#534559] to-[#9A8A9D] mx-[200px] my-[20px] relative h-[20%] rounded-md p-1">
        <Link href="/register">
          <div className="bg-gradient-to-tl from-[#534559] to-[#816F86] relative h-[20%] rounded-md py-4 px-3 flex justify-center items-center">
            <TbDirections size={200} className="mr-4" />
            <div className="relative h-full w-full">
              <h1 className="text-4xl font-extrabold w-full bg-gradient-to-t from-[#D1AA80] via-[#D9B895] to-[#EFDFCF] inline-block text-transparent bg-clip-text">
                Bússola de Referência do Aprendizado
              </h1>
              <p className="text-xl w-full line-clamp-3">
