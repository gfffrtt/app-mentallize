...
export const FourElementsMobile = ({
  keyId,
  clientId,
  clinicId,
}: MbtiTestProps) => {
    ...
    <main className="pt-6">
      <div className="flex flex-col gap-y-6 justify-center items-center">
        <div
          className={
            choice === "air"
              ? "w-[70%] h-[30%] group ring-2 ring-[#BB926B] ring-offset-2 rounded-md p-2 hover:shadow-2xl hover:scale-105 duration-300 ease-in-out"
              : "w-[70%] h-[30%] group ring-2 ring-[#534559] hover:ring-[#BB926B] ring-offset-2 rounded-md p-2 hover:shadow-2xl hover:scale-105 duration-300 ease-in-out"
          }
        ...
        >
          <h1
            className={
              choice === "air"
                ? "text-[28px] hover:cursor-pointer text-[#BB926B] font-bold duration-300 ease-in-out"
                : "text-[28px] hover:cursor-pointer group-hover:text-[#BB926B] font-bold text-[#534559] duration-300 ease-in-out"
            }
          >
            {air}
          </h1>
      ...
      <div className="flex flex-col w-screen items-center justify-center pt-8">
  ...
  return (
    <div className="mx-36 flex w-screen flex-col justify-center items-center gap-y-12 h-screen">
      <div className="flex flex-col items-center justify-center">
        ...
        <p className="font-semibold text-lg mx-5">
